...
Our CheckMates have reviewed the message and feel that there's nothing contentious or harmful about it. To understand why this is so, click the button below. 👌
...
Thank you for keeping Singapore safe!`,
  ...
  DEMO_SCAM_MESSAGE:
    'Imagine this is a scam message that you receive in another WhatsApp chat. *Forward this message in to CheckMate (this chat)*⤴️',
  DEMO_SCAM_PROMPT:
  ...
  NEW_USER:
    "Hello and welcome to CheckMate! We're glad you're here 😊. Would you like to go through a quick onboarding to see how CheckMate works? Otherwise, you can go ahead and send in dubious messages right now!",
  GET_STARTED:
    "No worries! You can get started immediately by sending in dubious messages you're unsure about. To learn more, you can visit https://checkmate.sg. Please only send in messages that you're unsure of, because our CheckMates will have to review these messages 🙏. Thank you!",
}
