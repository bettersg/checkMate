exports.USER_BOT_RESPONSES = {
  ...
  IRRELEVANT: "Thank you for waiting! Our CheckMates have reviewed the message and think it's *harmless*.👌 Still, such messages do add workload for our CheckMates, so we'd appreciate if you try and avoid sending in trivial messages in the future!",
