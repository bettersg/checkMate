exports.USER_BOT_RESPONSES = {
  ...
  DEMO_END: "See how it works now? When you see a message that you're unsure of 🤔, just forward it in and we'll help you check it ✅✅. It works for images/photos too!\n\n*A few tips/rules*\n1) Please send in only one message at a time! If you've got a series of messages, instead of forwarding them in all (which triggers us multiple times), please send in a screenshot of them instead\n2) Please only send in messages that you're unsure of, because our CheckMates have to review these messages 🙏.\n\nNow that you know how it works, would you like to add CheckMate to your contact list for easy finding in the future?",
...
exports.FACTCHECKER_BOT_RESPONSES = {
  ...
  OUTSTANDING_REMINDER: "Hi! You have {{num_outstanding}} messages remaining to assess. Would you like to be sent the next one in line?",
};
